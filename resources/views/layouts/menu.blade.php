<header class="header">
    <div class="menu">
        ...
        <div class="logo">
            <!--Logo-->
            <a href="{{route('home.index')}}"><img src="{{asset('imglogo.png')}}" alt="Logo"></a>
        </div>
        ...
        <div class="dropdown">
            <a class="btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink" 
                ...
                <img src="{{Auth::user()->profile->photo ? asset('storage/' . Auth()::user()
                ->profile->photo) : asset('img/user-default.png')}}" alt="Profile" class="img-profile">
